...
resource "aws_launch_configuration" "web_lc" {
  ...
  image_id                  = "ami-01428ed083fc6ed14"  # Replace with the actual AMI ID of "TestyImage"
  instance_type             = "t2.micro"
  associate_public_ip_address = true
  security_groups           = [aws_security_group.bastion-sg.id]
  iam_instance_profile      = "arn:aws:iam::086508667280:instance-profile/AWSCodeDeployForEC2"  # Replace with the instance profile ARN
}
